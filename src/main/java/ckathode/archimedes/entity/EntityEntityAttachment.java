...
public class EntityEntityAttachment extends Entity implements IEntityAdditionalSpawnData {
            ...
            if (riddenByEntity == null) {
                if (prevRiddenByEntity != null) {
                    if (ship != null && ship.isFlying()) {
                        EntityParachute parachute = new EntityParachute(worldObj, ship, pos.chunkPosX, pos.chunkPosY,
                                pos.chunkPosZ);
    ...
    public void readSpawnData(ByteBuf data) {
        ...
        if (entity instanceof EntityShip) {
            setParentShip((EntityShip) entity, data.readUnsignedByte(), data.readUnsignedByte(),
